    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Appointments_BarberId_StartUtc_EndUtc",
                table: "Appointments",
                columns: new[] { "BarberId", "StartUtc", "EndUtc" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Availabilities_BarberId_Type_Date",
                table: "Availabilities",
                columns: new[] { "BarberId", "Type", "Date" });

            migrationBuilder.CreateIndex(
                name: "IX_Availabilities_BarberId_Type_DayOfWeek",
                table: "Availabilities",
                columns: new[] { "BarberId", "Type", "DayOfWeek" });
